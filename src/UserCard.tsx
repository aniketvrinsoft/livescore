...
const NameDiv = styled.div`margin: 4px;`;

const UserCardDiv = styled.div`display: flex;
align-items: center;
    ...
    return (
        <UserCardDiv>
            <LeftDiv>
                ...
                <AvatarDiv style={{ backgroundColor: stringToColour(data.displayName) }}>{data.displayName[0]}</AvatarDiv>
